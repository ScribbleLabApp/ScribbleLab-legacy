...
> [!NOTE]
> ScribbleLab-legacy is currently in development and not yet ready for production use. You are welcome to test the [latest alpha/dev build](https://github.com/ScribbleLabApp/ScribbleLab/releases/latest) at your own risk. We welcome feedback [here](https://github.com/ScribbleLabApp/ScribbleLab/issues).

> [!WARNING]
> This is the legacy version of ScribbleLab which is supporting iOS 10+. If you are using a device with iOS 17+ or macOS 14+ then please use the [main version](https://github.com/ScribbleLabApp/ScribbleLab)
...
This project spans [multiple repositories](https://github.com/ScribbleLabApp/) so instead of browsing issues in the issues tab, it may be helpful to find an issue to get started on in our [project board](https://github.com/orgs/ScribbleLabApp/projects/1/views/1).
